...
function modelos(id){
  ...
  const APIModelos = fetch(`https://parallelum.com.br/fipe/api/v1/carros/marcas/${id}/modelos`)
...
function anos(idMarca, idModelo){
  ...
  const APIAnos = fetch(`https://parallelum.com.br/fipe/api/v1/carros/marcas/${idMarca}/modelos/${idModelo}/anos`)
    .then((respostaDoServer) => {
      return respostaDoServer.json();
    })
...
function buscaDadosVeiculo(idMarca, idModelo, idAno){
  ...
  const dados = fetch(`https://parallelum.com.br/fipe/api/v1/carros/marcas/${idMarca}/modelos/${idModelo}/anos/${idAno}`)
  .then((respostaDoServer) => {
    return respostaDoServer.json();
  })
...
export async function getStaticProps(){
  ...
  const API = await fetch('https://parallelum.com.br/fipe/api/v1/carros/marcas')
    .then((respostaDoServer) => {
      return respostaDoServer.json();
    });
